...
from .HomeSolarPowerFunctions import HomeSolarPowerFunctions as hspf
from .StorageBatteryFunctions import StorageBatteryFunctions as sbf
# ------------------------------------------------------------------
...
EPC_CODE = {
	...
	0x02: { # Housing/facility-related device class group
		...
		0x79: { # Home solar power generation class
			"class": "HomeSolarPower",
            "functions": {
                0x80: ('Operation status', hspf._027980),
                0xE0: ('Measured instantaneous amount of electricity generated', hspf._0279e0),
                0xE1: ('Measured cumulative amount of electric energy generated', hspf._0279e1)
            }
		},
		...
		0x7D: { # Storage battery class
            ...
            "functions": {
                0x80: ('Operation status', sbf._027d80),
                ...
                0xCF: ('Working operation status', sbf._027dcf),
                ...
                0xE4: ('Remaining stored electricity 3', sbf._027de4),
